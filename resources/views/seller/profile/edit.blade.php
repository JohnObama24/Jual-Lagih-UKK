...
@section('content')
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Kelola informasi akun tokomu</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-2xl border border-blue-100 p-6 shadow-sm text-center">
                ...
                <div class="mt-5 pt-4 border-t border-blue-50 space-y-3 text-left">
                    ...
                    @php
                        ...
                        $orderCount = \App\Models\Orders::whereHas('orderItems.product', fn($q) => $q->where('seller_id', $user->id))->count();
                    @endphp
                    <div class="flex justify-between text-xs">
                        <span class="text-gray-500">Total Produk</span>
                        <span class="font-semibold text-blue-700">{{ $productCount }}</span>
                    </div>
                    <div class="flex justify-between text-xs">
                        <span class="text-gray-500">Total Pesanan</span>
                        <span class="font-semibold text-blue-700">{{ $orderCount }}</span>
                    </div>
                </div>
            </div>
        </div>
